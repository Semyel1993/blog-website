...
def register():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            flash("This email is already exist, sign in instead.")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user:
            flash("This email doesn't exist, try another one.")
            return redirect(url_for("login"))
...
def show_post(post_id):
    ...
    comments = Comment.query.filter_by(parent_post_id=requested_post.id).all()
